                  ...
                  <div className="fetched_item_details_container df-ai">
                    ...
                    <div className="fetched_other_details_container df-ai">
                      ...
                      {item.extractType === 'track' ? (
                        <button className="fetched_other_details_add_btn dff">
                            Add
                        </button>
                      ) : (
